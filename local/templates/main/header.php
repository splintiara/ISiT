...
<head profile="http://gmpg.org/xfn/11">
    ...
    <!-- Load Pretty Photo -->
    <?Asset::getInstance()-> addCss(SITE_TEMPLATE_PATH."/_include/css/jprettyPhoto.css");?>
...
<div class="ornament">
    <div class="containit">
        ...
        <div class="logo"><!--<a href="index.html"><img src="<?=SITE_TEMPLATE_PATH;?>/images/logo.png" alt="Novux" />-->
            <?if(!CSite::InDir('/')):?><a href="/"><?endif;?>
                <img src="<?=SITE_TEMPLATE_PATH;?>/images/logo.png" alt="Novux" />
                <?if(!CSite::InDir('/')):?></a><?endif;?></a>
        </div>
